          ...
          >
            <CarouselContent className="-ml-4">
              {videos.map((video, index) => (
                ...
                >
                  <div className="group relative aspect-video overflow-hidden rounded-lg bg-black/40 ring-1 ring-white/10 shadow-2xl transition-transform duration-300 hover:-translate-y-1">
                    <iframe
