                  ...
                  <div className="relative h-[225px] w-full overflow-hidden bg-black sm:h-[240px]">
                    {isPlaying ? (
                      <div className="relative size-full">
                        ...
                        />
                        {/* Inline Close Button to return to poster */}
                        <button
                          type="button"
                          onClick={() => setPlayingId(null)}
                          aria-label={dict.close}
                          className="absolute right-2.5 top-2.5 z-20 flex size-8 cursor-pointer items-center justify-center rounded-full bg-black/80 text-white backdrop-blur-md transition-transform hover:scale-110 hover:bg-red-600"
                        >
                      ...
                      <div className="relative size-full">
                        ...
                        <button
                          ...
                          aria-label={`${dict.play}: ${title}`}
                          className="group/play absolute inset-0 flex cursor-pointer items-center justify-center"
                        >
                          <span className="relative flex size-14 items-center justify-center rounded-full border border-white/40 bg-white/20 text-white backdrop-blur-md shadow-xl transition-all duration-300 ease-out group-hover/play:scale-110 group-hover/play:border-sky-400 group-hover/play:bg-sky-500 sm:size-16">
                            <span
                              aria-hidden
                              className="absolute inset-0 rounded-full bg-white/20 animate-ping opacity-60 group-hover/play:bg-sky-400/40"
                            />
                            <Icon
                              name="play"
                              size="md"
                              className="ml-1 fill-white text-white transition-transform group-hover/play:scale-110"
                            />
                          </span>
                        </button>
                      </div>
